...
export const Skills = () => {
    return (
        <article className="w-full flex flex-col gap-2 overflow-auto scrolls">
            ...
            <ul className="w-full flex flex-col gap-4">
                <li className="w-[80%] bg-yellow-300/80 py-1 px-2 rounded-md text-[14px] font-semibold">
                ...
                <li className="w-[80%] bg-emerald-500/80 py-1 px-2 rounded-md text-[14px] font-semibold">
