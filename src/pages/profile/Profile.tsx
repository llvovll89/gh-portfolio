                            ...
                            <div className="flex flex-col w-full items-center gap-4">
                                ...
                                <div className="flex gap-3 mt-2">
                                    <a
                                        ...
                                        className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-primary/30 hover:scale-110 transition-all duration-200"
                                    >
