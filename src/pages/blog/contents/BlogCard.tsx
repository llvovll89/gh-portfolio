...
export const BlogCard = ({p}: BlogCardProps) => {
    return (
        <li className="list-none">
            ...
            >
                {/* 왼쪽 메타데이터 섹션 */}
                <div className="flex flex-col items-start gap-2 min-w-[140px] pr-6 border-r border-zinc-200/60 dark:border-zinc-700/60">
                ...
                <div className="flex-1 pl-6 min-w-0">
                    <h3 className="text-xl font-bold leading-snug text-zinc-900 dark:text-zinc-100 mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        {p.title}
                    </h3>
                ...
                {/* 호버 시 화살표 아이콘 */}
                <div className="ml-4 opacity-0 -translate-x-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0">
                    <svg
