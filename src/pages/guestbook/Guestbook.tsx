	...
	return (
		<>
			...
			<Contents className="select-none">
				<article className="flex flex-col h-[calc(100vh-8rem)] sm:py-4 py-1 md:px-0 px-2 relative gap-2">
					<div className="flex items-center justify-between max-w-5xl mx-auto w-full">
						<div className="flex items-center gap-3">
							<div className="p-2 bg-primary/10 rounded-lg">
								<FiMessageSquare className="sm:w-8 sm:h-8 w-5 h-5 text-primary" />
							</div>
							<h1 className="text-[clamp(1.2rem,2vw,1.5rem)] font-extrabold tracking-tight text-white/90">
						...
						<div className="flex items-center gap-2">
							<button
								...
								className="group cursor-pointer relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl sm:px-6 sm:py-3 px-4 py-2 text-[clamp(0.8rem,1.1vw,1rem)] md:text-base font-bold transition-all duration-300 bg-linear-to-r from-primary via-blue-500 to-cyan-400 text-white shadow-2xl shadow-primary/30 hover:shadow-primary/50 hover:scale-105 active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2"
							>
								<FaPencil className="sm:w-5 w-4 sm:h-5 h-4 transition-transform group-hover:-translate-y-0.5" />
					...
					<div className="space-y-6 sm:p-4 p-2 m-auto overflow-y-auto scrolls w-full h-full max-w-5xl">
									...
									<div className="md:mx-0 md:my-0">
										<div className="md:hidden">
											<div className="fixed left-0 right-0 bottom-0 z-50">
												<div className="max-h-[85dvh] overflow-y-auto rounded-t-2xl shadow-xl bg-black/90 backdrop-blur-xl p-4 animate-in slide-in-from-bottom">
