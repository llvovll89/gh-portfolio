...
export const Aside = () => {
    const {isVisibleSidebar, setIsVisibleSidebar} =
        useContext(GlobalStateContext);

    return (
        <aside className={`${isVisibleSidebar ? "-translate-x-75" : ""} w-75 absolute left-0 top-0 h-screen transition-all ease-linear bg-main border-r border-sub-gary/30 flex flex-col z-1`}>
