...
"정의 → 언제 쓰는지 → 짧은 예시" 순서로 구성했어요.

---

## 목차

- [1) 코테용 입력 템플릿(Node.js)](#1-코테용-입력-템플릿nodejs)
- [2) 시간복잡도 감각](#2-시간복잡도-감각)
- [3) JS 자료구조 치트시트](#3-js-자료구조-치트시트)
- [4) 필수 패턴](#4-필수-패턴)
- [5) 그래프 탐색(BFS/DFS)](#5-그래프-탐색bfsdfs)
- [6) DP(동적 계획법) 기초](#6-dp동적-계획법-기초)
- [7) 그리디 기초](#7-그리디-기초)
- [8) 실수 방지 체크리스트](#8-실수-방지-체크리스트)
